DISCUSSION:
This is part 1 of the assignment, I have changed the format to latex as I am using sublime text editor. I was able to add boolean type variables and implement boolean operators. This program is not fully funcitonal as it doesn't do type check. I have implemented type check functions but was not able to put them together, the type check functions are commented. I was not able to finish this assignment because it took awhile to get my head around what the code does, I think I would be able to add type checks if I had more time.
